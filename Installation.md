# 🐾 Animalsay Jubilee — Installation & Usage Guide

This guide explains how to **install**, **import**, and **use** the Python package  
`animalsay_jubilee_yl9778` created by Team Jubilee.
